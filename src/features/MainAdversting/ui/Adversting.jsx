      ...
      <div className="flex flex-col text-white gap-y-[42px]">
        ...
        <div className="flex flex-wrap  items-center justify-between  gap-y-[20px]">
          {filteredAds.map((ad, index) => (
            <div className="flex flex-col w-[560px] " key={index}>
              <div className="bg-[#FE0202] mx-auto rounded-full w-[99.7%] mb-[-17px] h-[20px] md:w-[70%] md:h-[15px] "></div>
              <div
                style={{
                ...
                className="md:pl-[40px] pl-[15px] py-5  h-full rounded-md z-50"
              >
                <div className="flex flex-col justify-between h-full gap-2 ">
                  <div className="flex p-[15px]">
                    <img className="hidden md:block" src={phoneicon} alt="Phone Icon" />
                  ...
                  <div className="flex flex-col gap-y-[7px] ">
                    <div className="flex items-center gap-2">
                      <img
                        src={mapPin}
                        alt="Map Pin"
                        className="w-[6px] md:w-[15px] h-[16px] md:h-[6px]"
                      />
                      <p className="text-white text-[12px] md:text-[14px]">
                        {ad.address}
                      </p>
                    </div>
                    <button className="flex items-center gap-x-2 justify-start text-white w-[120px]  py-[5px] px-[10px] border border-white rounded-lg">
                      <img    
                        src={instgram}
                        alt="Instagram Icon"
                        className="w-[8px] md:w-[15px] h-[8px] md:h-[16px]"
                      />
                      <span className="md:text-xs text-[10px]">Мы в {ad.instagram}</span>
                    </button>
                  </div>
                </div>
              </div>
              <div className="bg-[#FE0202] mx-auto rounded-full z-0 w-[99.8%] mt-[-17px] h-[20px] md:w-[70%] md:h-[15px] "></div>
            </div>
          ))}
        </div>
      </div>

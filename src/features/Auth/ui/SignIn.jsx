...
const SignIn = () => {
    ...
    return (
        <div className="flex items-center justify-center w-full min-h-screen p-4 bg-center bg-cover" style={{ backgroundImage: `url(${istockphoto})` }}>
            <div className="bg-white p-5 rounded-lg shadow-lg w-full max-w-[550px] h-auto sm:h-[500px] mx-auto">
                ...
                <h2 className="mt-4 text-lg font-semibold sm:text-xl text-start">Добро пожаловать!</h2>
                    ...
                    {({ isSubmitting }) => (
                        <Form className="space-y-4">
                            ...
                            <div className="flex flex-row items-center justify-between mb-4 sm:flex-row">
                                ...
                                <a href="#" className="mt-2 text-blue-500 sm:mt-0">Забыли пароль?</a>
                            </div>
                            <button
                                type="submit"
                ...
                <p className="mt-4 text-center text-gray-500">
                    Если вы не зарегистрированы, нажмите <Link to='/auth/sign-up' className="text-blue-500">Регистрация</Link>
                </p>
            </div>
        </div>
    );

...
const Trainer = () => {
  ...
  return (
    <NavBarContainer>
      ...
      <div className=' h-[45px]  text-[24] mt-5  font-bold text-black bg-slate-200 rounded-[8px] px-10 flex justify-between items-center'>
        <p> Имя</p>
        <p>Email</p>
        <p>Спорт</p>
      </div>
      <div className='border-b font-normal border-[#B6B7BC]  flex justify-around  items-center p-3 '>
        <p className='flex items-center gap-2'> <img className='w-10 rounded-[50px]' src='https://img.freepik.com/free-photo/3d-fox-cartoon-illustration_23-2151395236.jpg?size=338&ext=jpg&ga=GA1.1.1819120589.1727222400&semt=ais_hybrid' alt="" />Махмудов Термирлан</p>

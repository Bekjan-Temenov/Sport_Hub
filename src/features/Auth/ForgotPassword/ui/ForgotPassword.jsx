...
const ForgotPassword = () => {
  ...
  return (
      <div className="w-full min-h-screen flex items-center justify-center bg-cover bg-center p-4" style={{backgroundImage: `url(${istockphoto})`}}>
          <Container>
              <div className='bg-white p-8 rounded-lg shadow-lg w-full flex flex-col gap-4 justify-center max-w-[500px] h-auto sm:h-[400px] mx-auto'>
                  <h2 className="text-3xl font-bold text-center">Забыли пароль</h2>
                  <p className="text-start w-[330px] text-[15px]">
                      ...
                      {({ isSubmitting }) => (
                          <Form className="space-y-6">
                              ...
                              <div className="text-start">
                                  <Link className="text-blue-500 underline">Вернуться на авторизацию</Link>
                              </div>
                              ...
                              <div>
                                  <button
                                      ...
                                      className="w-full py-3 bg-[#FE0404] text-white rounded-lg"
                                  >
                                      Отправить
                                  </button>
                              </div>
